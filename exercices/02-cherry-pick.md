...
namespace App {
    ...
    abstract class Sorceleur extends Personnage {
        public function __construct(private string $name, private int $lifepoints = 120)
        {
            parent::__construct($name, $lifepoints);
        }
    }
